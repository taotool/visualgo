  ...
  return (
    <Box sx={{ flexGrow: 1, p: 0 }} style={{ margin: '0px' }}>
      ...
      >
        ...
        {
          algorithms
            .filter((algorithm) => !alg || algorithm.segment === alg)
            .map((algorithm, idx) => (
              <Grid
                key={idx}
                minHeight={160}
                ...
                >
                  ...
                  <CardContent >
                    ...
                    >
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: 'text.secondary', textTransform: 'uppercase', cursor: 'pointer'}}
                        onClick={() => navigate(algorithm.segment)}
                      >
                        {!alg && algorithm.segment}
                      </Typography>

                      {/* <IconButton color="primary" aria-label="minimize" onClick={()=>navigate(algorithm.more)} >
